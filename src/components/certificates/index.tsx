    ...
    return (
        <section id="certificates" className="py-24 px-10 lg:px-28 relative">
            ...
            <div className="flex items-center gap-2">
                ...
                <div ref={scrollRef} className="flex flex-1 w-full overflow-x-auto overflow-y-hidden space-x-4 flex-nowrap hide-scrollbar">
            ...
            {isCertificateDetailOpen && <CertificateDetailModal certificate={selectedCertificate} closeCertificateDetailModal={closeCertificateDetailModal} />}
        </section>
    )
}
