...
import { FaBootstrap, FaCss3, FaDatabase, FaGithub, FaHtml5, FaJava, FaJs, FaLanguage, FaPython, FaReact } from "react-icons/fa";
import { RiNextjsLine } from "react-icons/ri";
import { SiArduino, SiDjango, SiMysql, SiPostgresql, SiSqlite, SiTailwindcss } from "react-icons/si";
...
export const SkillsSection = (props: Props) => {
    return (
        <section id="skills" className="py-24 px-10 lg:px-28 space-y-16">
            ...
            <div className="space-y-16">
                <Title3 Icon={CursorIconPurple} text="Frameworks, Technologies, Libraries and Others" bgCircleColor="bg-purple-700" borderColor="border-purple-700" />
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 ">
                    <TechnologyCard
